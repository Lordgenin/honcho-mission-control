...
export function getDemoSnapshot() {
  ...
  const conclusions = [
    ...
    { id: 'c2', workspace_id: 'example-workspace', peer_id: 'review-bot', text: 'Dashboard controls must remain disabled in public mode unless a trusted operator explicitly enables writes server-side.', confidence: 0.94, created_at: '2026-05-23T19:12:00Z' }
  ];
  const webhooks = [

...
import { normalizeCollection, normalizeV3Message, normalizeV3Session } from './data-utils.js';
...
export async function getHonchoSnapshot() {
  ...
  if (env.USE_DEMO_DATA) return { source: 'demo', readOnly: !env.ENABLE_MUTATIONS, env: publicEnv, status: { ok: true }, ...getDemoSnapshot() };
